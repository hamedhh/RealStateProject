    ...
    jQuery(function () {
        if (jQuery('body').is('.aa-price-range')) {
            ...
            skipSlider.noUiSlider.on('update', function (values, handle) {
                skipValues[handle].innerHTML = parseInt(values[handle]).toLocaleString().replace(/,/g, ",");
            });

            // FOR PRICE SECTION

            var skipSlider2 = document.getElementById('aa-price-range1');
            ...
            var skipSlider3 = document.getElementById('aa-price-range2');
            ...
            skipSlider2.noUiSlider.on('update', function (values, handle) {
                skipValues2[handle].innerHTML = parseInt(values[handle]).toLocaleString().replace(/,/g, ",");
            });

            skipSlider3.noUiSlider.on('update', function (values, handle) {
                skipValues3[handle].innerHTML = parseInt(values[handle]).toLocaleString().replace(/,/g, ",");
            });
        }
    });
